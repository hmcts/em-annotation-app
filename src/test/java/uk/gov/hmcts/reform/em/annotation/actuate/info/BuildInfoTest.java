package uk.gov.hmcts.reform.em.annotation.actuate.info;
...
public class BuildInfoTest {
    ...
    public void shouldAddBuildInfoToBuilderNullBuildInfo() throws Exception {
        BuildInfo dmBuildInfo = new BuildInfo("name","env","project",null);
    ...
    public void shouldAddBuildInfoToBuilderIncludesBuildNumber() throws Exception {
        BuildInfo dmBuildInfo = new BuildInfo("name","env","project",BUILD_INFO_WITH_BUILD_NO);
